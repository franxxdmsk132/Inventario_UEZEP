...
public class MueblesDao {
    ...
    public void save(Muebles muebles) {
        String sql = "INSERT INTO `muebles`(codigo_mueble, nombre_mueble, descripcion_mueble, fecha_ingreso, estado,condicion, cantidad, asignacion) VALUES ( ?, ?, ?, ?, ?,?, ?,0)";
